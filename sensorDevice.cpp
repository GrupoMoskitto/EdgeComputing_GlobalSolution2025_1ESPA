...
// Versão v1.1 - revisão 2025-06-01
...
const char* mqttClientID = "fiware_01"; // ID do cliente MQTT

// Tópicos MQTT (configurado para dispositivo SensorDevice:001)
// (para adicionar mais dispositivos fazer as requisições POST no Postman de acordo com o FIWARE e as variáveis no código)
...
void loop() {
 ...
 // Aguarda 8 segundos antes de enviar novamente
 delay(8000);
}
